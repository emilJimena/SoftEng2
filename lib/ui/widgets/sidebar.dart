    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          ...
          if (widget.role.toLowerCase() == "manager" && widget.onMenu != null)
            _SidebarItem(
              imagePath: "assets/images/addon.png",
              label: "Addons",
              isOpen: widget.isSidebarOpen && showText,
              onTap: widget.onAddons, // <-- define this in the parent
              hovered: hoveredLabel == "Addons",
              isActive: widget.activePage == "addons",
              gradientColors: gradientColors,
              onHover: (hovering) =>
                  setState(() => hoveredLabel = hovering ? "Addons" : null),
            ),
          if (widget.role.toLowerCase() == "manager" &&
              widget.onAddMenuAddon != null)
            _SidebarItem(
              imagePath: "assets/images/addon.png",
              label: "Add Menu Addon",
              isOpen: widget.isSidebarOpen && showText,
              onTap: widget.onAddMenuAddon, // 👈 calls the new callback
              hovered: hoveredLabel == "Add Menu Addon",
              isActive: widget.activePage == "add_menu_addon",
              gradientColors: gradientColors,
              onHover: (hovering) => setState(
                () => hoveredLabel = hovering ? "Add Menu Addon" : null,
              ),
            ),
          if (widget.role.toLowerCase() == "manager" &&
            ...
            _SidebarItem(
              imagePath:
                  "assets/images/voucher.png", // create a voucher icon in assets
              label: "Create Voucher",
              isOpen: widget.isSidebarOpen && showText,
              onTap: widget.onCreateVoucher,
              hovered: hoveredLabel == "Create Voucher",
              isActive: widget.activePage == "create_voucher",
              gradientColors: gradientColors,
              onHover: (hovering) => setState(
                () => hoveredLabel = hovering ? "Create Voucher" : null,
              ),
            ),

          if (widget.role.toLowerCase() == "manager" &&
              widget.onAssignVoucher != null)
            _SidebarItem(
              imagePath:
                  "assets/images/assign_voucher.png", // assign voucher icon
              label: "Assign Voucher",
              isOpen: widget.isSidebarOpen && showText,
              onTap: widget.onAssignVoucher,
              hovered: hoveredLabel == "Assign Voucher",
              isActive: widget.activePage == "assign_voucher",
              gradientColors: gradientColors,
              onHover: (hovering) => setState(
                () => hoveredLabel = hovering ? "Assign Voucher" : null,
              ),
            ),
